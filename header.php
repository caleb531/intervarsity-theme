...
<body <?php body_class( 'hfeed site' ); ?>>
	...
	<header id="site-header">
		...
		<div id="site-logo">
			...
			<a rel="home" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo ( has_header_image() ? get_header_image() : IV_DEFAULT_HEADER_IMAGE_URL ); ?>" alt="" /></a>
		...
		<div id="site-header-core">
			...
			<?php if ( has_nav_menu( 'header_menu' ) ): ?>
				...
				wp_nav_menu( array(
					...
					'items_wrap'	 => '<h2 class="screen-reader-text">Site Navigation (Header)</h2><button id="nav-control-responsive">' . get_iv_icon('navigation') . '<span class="screen-reader-text">Menu</span></button><ul id="%1$s" class="%2$s">%3$s</ul>',
					'container'		 => 'nav',
